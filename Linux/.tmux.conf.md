...
set-option -g status-right "#[fg=colour49,bg=colour237] #(curl -s ifconfig.co) | #[fg=colour49,bg=colour237] #(ip -o -4 add show dev eth0 2>/dev/null |  awk {'print $4'} | cut -f1 -d/)  | #[fg=colour49,bg=colour237] %H:%M  |#[fg=colo50, bg=colour237] #h "
